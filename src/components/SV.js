...
const SV=()=>{
    return(<div className="container-fluid">
        ...
        <br />
        <h5 style={{"font-family": "'Montserrat', 'sans-serif'"}}>42 Silicon Valley is an innovative engineering college in the San Francisco Bay Area. “Code for Fun” is a nonprofit organization committed to exposing all students to computer science at an early age.  </h5><br/>
        <ul>
